    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(Category category)
        {
           ...
           bool result=await _context.Categories.AnyAsync(c=>c.Name==category.Name);
            if (result)
            {
                ModelState.AddModelError(nameof(Category.Name), $"{category.Name} Bu adda category var");
                return View();
        ...
        public async Task<IActionResult> Update(int? id,Category category)
        {
            ...
            if (result)
            {
                ModelState.AddModelError(nameof(Category.Name), $"{category.Name} adli category var");
                return View();
            }
